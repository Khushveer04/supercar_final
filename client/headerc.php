...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
	...
	<div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
		<div class="navbar-nav">
            ...
            <a href="login.php" class="nav-item nav-link">Demande d'essai</a>		
 ...
 <!-- <div uk-sticky="sel-target: .uk-navbar-container; cls-active: uk-navbar-sticky; bottom: #transparent-sticky-navbar">
    ...
    <nav class="uk-navbar-container uk-height-max-small uk-navbar='dropbar: true'" id="navcolor" uk-navbar style="position: relative; z-index: 980;" uk-navbar="dropbar: true">
    ...
    <div class="uk-navbar-right">
        <ul class="uk-navbar-nav">
            <li><a href="index_admin.php" class="uk-icon-link" uk-icon="lock" uk-tooltip="title: Admin"></a></li>
        </ul>
    </div> -->
